...
echo  °ÛÛÛ   °ÛÛÛ  °ÛÛÛÛ      UCDIR, Ultra Compress Directory [1.0]
echo °Û  °Û   °Û   °Û  °Û     'Compresses a complete directory structure into
echo °ÛÛÛÛÛ   °Û   °ÛÛÛÛ  -NL  an UC2 archive to save diskspace'
